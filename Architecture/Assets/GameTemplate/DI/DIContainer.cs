...
namespace GameTemplate.DI
{
    public class DIContainer
    {
        ...
        public T Resolve<T>(string tag = null)
        {
            ...
            {
                throw new Exception($"Cyrcle dependency for tag {key.tag} and type {key.Item2.FullName} ");
            }
            ...
            throw new Exception($"Couldnt find dependency for tag  {tag} and type {key.Item2.FullName} ");
        }
